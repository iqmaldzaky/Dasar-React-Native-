...
let item1 = items[0]; let item2 = items[1]; let item3 = items[2];
...
// Object 
let student = { name: "Ahmad", age: 22, department: "Information System"
}
...
const studentData = () => { return { name: "Roni", age: 19, department: "Information System" }
}

let { name: studentNameData, age: studentAgeData, department: studentDepartmentData
} = studentData();
